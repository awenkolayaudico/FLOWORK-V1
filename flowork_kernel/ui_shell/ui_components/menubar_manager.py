...
class MenubarManager:
    ...
    def build_menu(self):
        ...
        if monetization_is_active:
            self.kernel.write_to_log("UI: Monetization is active, showing license menu items.", "DEBUG")
            ...
            self.kernel.write_to_log("UI: Monetization is inactive, hiding license menu items.", "DEBUG")
        file_menu.add_separator()
