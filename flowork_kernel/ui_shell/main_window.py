...
class MainWindow(ttk.Window):
    ...
    def handle_license_deactivation_request(self):
        ...
        if messagebox.askyesno(
            ...
            threading.Thread(target=self._deactivate_worker, args=(license_service,), daemon=True).start()
    def _deactivate_worker(self, license_service):
        """Worker function to call the deactivation in the background."""
        success, message = license_service.deactivate_license_on_server()
